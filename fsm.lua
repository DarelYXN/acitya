...
local Toggle9 = Section2:CreateToggle("Random Chest", nil, function(State)
    toggle = State
        while toggle do
...
local Toggle5 = Section2:CreateToggle("Suken Chest", nil, function(State)
    toggle = State
        while toggle do
            wait(5)
             for i, v in pairs(game.Workspace:GetChildren()) do
...
---------------------------------------------------------------------
Section4:CreateLabel("Teleport")

local Dropdown2 = Section4:CreateDropdown("Store", {"Boat Store","Raygan's Tavern","Supplies Store", "Pets Store"}, function(String)
    locationSelected = String
end)

local Button1 = Section4:CreateButton("Teleport", function()
...
local Dropdown3 = Section4:CreateDropdown("Location", {"Port Jackson","Ancient Shores","Shadow Isles", "Pharaoh's Dunes", "Eruption Island", "Monster's Borough", "Suken Ship"}, function(String)
    locationSelected = String
end)

local Button2 = Section4:CreateButton("Teleport", function()
...
Section3:CreateLabel("Boats")

local Slider1 = Section3:CreateSlider("Boat Speed", 0,150,nil,true, function(Value)
 for i, v in pairs(game.Workspace:GetChildren()) do
...
local Button3 = Section3:CreateButton("Tp to Boat", function()
    for i, v in pairs(game.Workspace:GetChildren()) do
        if v.Name == (game.Players.LocalPlayer.Name .. "'s Boat") then
...
local Button4 = Section3:CreateButton("Remove Borders", function()
    for i, v in pairs(game.Workspace.IgnoredByMouse.BoatBorders:GetChildren()) do
        v:Destroy()
    end
end)   

Section3:CreateLabel("Pets")


local Dropdown4 = Section3:CreateDropdown("Egg's", {"Royals","Normal","Ruby", "Void", "Silver", "Stone", "Gold"}, function(String)
    eggs = String
end)

local Button8 = Section3:CreateButton("Buy", function()
    if eggs == "Royal" then
...
Section5:CreateLabel("Misc")


local Button8 = Section5:CreateButton("Instant ProximityPrompt", function()
game:GetService("ProximityPromptService").PromptButtonHoldBegan:Connect(function(prompt)
   prompt.HoldDuration = 0
end)
end) 

local Button5 = Section5:CreateButton("Rejoins", function()
tpservice:Teleport(game.PlaceId, plr)
end) 

local Button6 = Section5:CreateButton("Server Hop", function()
switchServer()
end)   

local Button7 = Section5:CreateButton("Discord", function()
setclipboard("adgXmSMCUM") 
end)

local Toggle7 = Section5:CreateToggle("UI Toggle", nil, function(State)
    Window:Toggle(State)
end)
